      ...
      <section className="bg-white">
        ...
        {members.length ? (
          <div className="grid gap-x-8 gap-y-14 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            {members.map((member) => (
              ...
              >
                ...
                <h2 className="mt-5 max-w-[14rem] text-base font-extrabold uppercase leading-tight tracking-[0.08em] text-[var(--brand-navy)]">
                  {member.name}
                </h2>
          ...
          <div className="brand-card py-16 text-center">
            <h2 className="text-2xl font-extrabold text-[var(--brand-navy)]">No team members found</h2>
            <p className="mt-2 text-[var(--brand-muted)]">Add people from the admin panel to show them here.</p>
          </div>
        )}
        </div>
      </section>

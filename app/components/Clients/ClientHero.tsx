  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-linear-to-br from-[var(--brand-navy)] via-[var(--brand-navy)] to-[var(--brand-navy)]" />
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-[var(--brand-red)] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse animation-delay-2000" />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[var(--brand-red)] rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse animation-delay-4000" />
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="relative inline-block">
              <span className="bg-linear-to-r from-red-500 to-[var(--brand-red)] bg-clip-text text-transparent">
                Industry Leaders
              </span>
              <motion.div
                initial={{ width: 0 }}
                ...
                className="absolute -bottom-3 left-0 h-1 bg-linear-to-r from-red-500 to-[var(--brand-red)] rounded-full"
              />
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-blue-50/80 max-w-3xl mx-auto mb-12"
          >
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 bg-linear-to-r from-red-500 to-[var(--brand-red)] rounded-xl mb-3 group-hover:scale-110 transition-transform duration-300">
                  <stat.icon className="w-6 h-6 text-white" />
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-1">{stat.value}</div>
                <div className="text-xs md:text-sm text-blue-50/80">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <div className="flex flex-col items-center gap-2">
              <span className="text-sm text-[var(--brand-muted)]">Scroll to explore</span>
              <motion.div
                animate={{ y: [0, 10, 0] }}

...
const AboutUs = ({ className }: AboutUsProps) => {
  ...
  return (
    <section
      ref={ref}
      className={cn(
        "relative overflow-hidden bg-linear-to-b from-gray-50 to-white py-24", // Fixed: bg-linear-to-b
        className
      )}
    >
      ...
      <div className="container relative mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={cardVariants} className="relative group">
            <div className="absolute -inset-0.5 bg-linear-to-r from-red-600 to-blue-600 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-1000 group-hover:duration-200" />
          ...
          {/* Vision Card */}
          <motion.div variants={cardVariants} className="relative group">
            <div className="absolute -inset-0.5 bg-linear-to-r from-blue-600 to-emerald-600 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-1000 group-hover:duration-200" />
            <div className="relative bg-white p-8 rounded-2xl border border-gray-200">
              <div className="inline-flex items-center gap-3 mb-6">

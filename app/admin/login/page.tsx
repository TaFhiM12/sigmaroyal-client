...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[var(--brand-navy)] via-[var(--brand-navy)] to-[var(--brand-navy)] flex items-center justify-center px-4 py-12">
      ...
      <Card className="relative z-10 w-full max-w-md border-blue-950 bg-[var(--brand-navy)]/95 text-white shadow-2xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-blue-50">Email</Label>
              <Input
                id="email"
                type="email"
                value={email}
                ...
                required
                className="bg-[var(--brand-navy)] border-blue-900 text-white"
              />
            </div>

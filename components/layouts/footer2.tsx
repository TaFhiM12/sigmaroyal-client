...
const Footer2 = ({
  ...
  return (
    <footer className={cn("relative overflow-hidden bg-blue-950 text-white", className)}>
      ...
      {/* Main Footer Content */}
      <div className="container relative mx-auto px-4 py-9 md:px-6 md:py-10 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_1fr]">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                <Link href={logo.url} className="group flex items-center gap-3">
                  <span className="flex h-12 w-11 items-center justify-center rounded-lg bg-white/8 ring-1 ring-white/12 transition-colors group-hover:bg-white/12">
                    <Image
                      src="/logo.png"
                      alt={logo.alt}
                      width={40}
              ...
              <p className="max-w-xl text-sm leading-6 text-blue-50/85">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              {/* Head Office */}
              <div className="rounded-lg border border-white/10 bg-white/[0.035] p-4 shadow-lg shadow-blue-950/10 backdrop-blur-sm">
                <h3 className="mb-2.5 text-sm font-extrabold text-blue-100">Head Office</h3>
                <div className="space-y-2 text-sm leading-5 text-blue-50/90 [&_a]:text-blue-50 [&_p]:text-blue-50 [&_span]:text-blue-50">
              ...
              {/* Business Office */}
              <div className="rounded-lg border border-white/10 bg-white/[0.035] p-4 shadow-lg shadow-blue-950/10 backdrop-blur-sm">
                <h3 className="mb-2.5 text-sm font-extrabold text-blue-100">Business Office</h3>
                <div className="space-y-2 text-sm leading-5 text-blue-50/90 [&_a]:text-blue-50 [&_p]:text-blue-50 [&_span]:text-blue-50">
                  <div className="flex items-start gap-3">
              ...
              {/* Sirajgonj Office */}
              <div className="rounded-lg border border-white/10 bg-white/[0.035] p-4 shadow-lg shadow-blue-950/10 backdrop-blur-sm md:col-span-2">
                <h3 className="mb-2.5 text-sm font-extrabold text-blue-100">Sirajgonj Office</h3>
                <div className="grid gap-2 text-sm leading-5 text-blue-50/90 md:grid-cols-3 [&_a]:text-blue-50 [&_p]:text-blue-50 [&_span]:text-blue-50">
                  <div className="flex items-start gap-3">
                    <MapPin className="mt-1 size-4.5 flex-shrink-0 text-red-400" />
            ...
            <div className="flex items-center gap-4">
              <h3 className="text-sm font-extrabold text-blue-100">Connect With Us</h3>
              <div className="flex gap-2">
                <a
                  ...
                  className="rounded-md bg-white/8 p-2 ring-1 ring-white/10 transition-all hover:-translate-y-0.5 hover:bg-red-600 hover:ring-red-500/40"
                >
                  <Linkedin className="h-4 w-4" />
                </a>
                <a href="mailto:info@sigma-royal.com" aria-label="Email" className="rounded-md bg-white/8 p-2 ring-1 ring-white/10 transition-all hover:-translate-y-0.5 hover:bg-red-600 hover:ring-red-500/40">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {menuItems.map((section, index) => (
              <div key={index} className="rounded-lg border border-white/10 bg-white/[0.035] p-4 shadow-lg shadow-blue-950/10 backdrop-blur-sm">
                <h3 className="border-b border-white/10 pb-2.5 text-sm font-extrabold text-blue-100">
                  {section.title}
                </h3>
                <ul className="mt-2.5 space-y-1">
                  {section.links.map((link, linkIndex) => (
                    <li key={linkIndex}>
                      <Link 
                        href={link.url}
                        className="group flex items-center justify-between gap-2 rounded-md px-1.5 py-1 text-sm text-blue-50/78 transition-all duration-200 hover:bg-white/7 hover:text-white"
                      >
                        <span>{link.text}</span>
